...
return (
    <div className="shadow-2xl">
      ...
      <FadeIn className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 m-5">
        ...
        <Project name="SAW: 60 Seconds" description ="This game was made in 48 hours for the Ludum Dare Competition, scoring ~70th in Mood." imglink="https://img.itch.zone/aW1nLzQzNTkyMjAucG5n/original/tmjQOO.png" gameLink="https://patrickrmc.itch.io/60-second-loop" />
